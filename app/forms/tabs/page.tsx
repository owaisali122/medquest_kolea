  ...
  useEffect(() => {
    const fetchPendingForms = async () => {
      try {
        ...
        const response = await fetch('/api/forms/pending?formSlug=tabs&allSessions=true')
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Tabs Forms</h1>
              <p className="mt-1 text-gray-600">
                Manage your tabs forms - continue where you left off or start new
              </p>
            </div>
            <Link
              href="/forms/tabs/new"
              ...
              {pendingForms.map((form) => (
                ...
                >
                  ...
                  <div className="col-span-3 flex justify-end gap-2">
                    <Link
                      href={`/forms/tabs/${form.id}?tab=${form.currentStep}`}
